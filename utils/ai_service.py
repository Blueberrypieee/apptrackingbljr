...
Berdasarkan materi berikut, buatlah TEPAT 10 pertanyaan essay yang menguji pemahaman.

Aturan WAJIB:
- Semua pertanyaan HARUS bisa dijawab hanya dari materi yang diberikan, jangan keluar dari materi
- Sesuaikan tingkat kesulitan dengan isi materi — kalau materi sederhana, buat pertanyaan yang sederhana juga
- Buat pertanyaan yang bervariasi: 4 pertanyaan pemahaman dasar, 3 pertanyaan analisis, 3 pertanyaan aplikasi
- Gunakan bahasa yang jelas dan mudah dipahami
- Jangan buat pertanyaan yang jawabannya hanya ya/tidak
- Jangan buat pertanyaan yang terlalu spesifik atau teknikal kalau materi tidak membahasnya
...
Evaluasi jawaban siswa berdasarkan kriteria berikut:
- Score 9-10: Jawaban lengkap, tepat, menunjukkan pemahaman yang baik
- Score 7-8: Jawaban sebagian besar benar, ada poin penting yang disampaikan meski tidak sempurna
- Score 5-6: Jawaban menunjukkan pemahaman dasar tapi masih banyak yang kurang
- Score 3-4: Jawaban ada tapi banyak yang salah atau tidak relevan
- Score 0-2: Jawaban tidak relevan atau tidak menjawab pertanyaan sama sekali

PENTING:
- Berikan kredit untuk setiap poin benar yang disebutkan meski tidak sempurna
- Jangan terlalu strict — kalau inti jawaban benar, berikan score yang layak
- Jawaban tidak harus persis sama dengan materi, yang penting esensinya benar
